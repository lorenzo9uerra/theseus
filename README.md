...
Due to a parsing error in the aggregation script, the False Positive Rate (FPR) reported in **Table 2** for the **Velox** baseline on the **CADETS** dataset was incorrect. The correct value is:
