...
def load_vectors(wv):
    """loads word embeddings from alacarte model.wv
    Args:
        wv: alacarte output keyed-vectors
    Returns:
...
def feat_training_for_one_split(
    ...
    if model_input is None:
        ...
        # adjust alacarte context window size for segmentation
    ...
    log("alacarte Training loss: {}".format(w2v_loss))
    log(
        "=== ----------------------------------------------------------------------------------------"
    )
