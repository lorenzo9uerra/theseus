...
def train_word2vec(corpus, model_save_path, cfg):
    ...
    window_size = cfg.featurization.feat_training.temporal_rw.window_size
    min_count = cfg.featurization.feat_training.temporal_rw.min_count
    use_skip_gram = cfg.featurization.feat_training.temporal_rw.use_skip_gram
    num_workers = cfg.featurization.feat_training.temporal_rw.wv_workers
...
def main(cfg):
    ...
    corpus_base_dir = cfg.featurization.feat_training.temporal_rw._random_walk_corpus_dir
