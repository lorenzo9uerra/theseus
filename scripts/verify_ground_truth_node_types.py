...
This script checks whether all UUIDs in the ground truth files correspond to
process nodes in the process_node_table files. This is important for
understanding whether evaluation should be limited to process nodes only.

Usage:
    python scripts/verify_ground_truth_node_types.py
    python scripts/verify_ground_truth_node_types.py --dataset THEIA_E3
    python scripts/verify_ground_truth_node_types.py --verbose
"""
