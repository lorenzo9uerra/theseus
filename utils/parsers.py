...
def parse_args(args=None):
    parser = argparse.ArgumentParser(
        description="Train or evaluate Theseus on a supported provenance dataset."
    )
    parser.add_argument(
        "dataset",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a custom YAML config file that overrides the auto-selected tuned/default Theseus config.",
    )
    parser.add_argument(
        "--data_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        choices=["mean", "sum"],
        default="mean",
        help="Reduction to use for reconstruction MSE during training.",
    )
