...
def _resolve_plot_output_paths(out_file: str) -> tuple[str, str]:
    base, ext = os.path.splitext(out_file)
    ext = ext.lower()

    if ext == ".png":
        return f"{base}.pdf", out_file
    if ext == ".pdf":
        return out_file, f"{base}.png"

    return f"{out_file}.pdf", f"{out_file}.png"
...
def plot_anomaly_score_distribution(
    ...
    pdf_file, png_file = _resolve_plot_output_paths(out_file)
